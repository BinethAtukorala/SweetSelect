classdef LBRiiwaClass
    ...
    methods
        ...
        function moveFrontFromMidway(obj, LBRiiwa, Box_Gripper, Box)
        ...
        function moveBackToMidway(obj, LBRiiwa, Box_Gripper, Initial_Box_Pose, Box)
        ...
        function moveBackFromMidway(obj, LBRiiwa, Box_Gripper, Box)
        ...
        % This function is to move box with filled candy (have to edit to
        % make all 3 candies move with box)

        function moveWithFilledBox(obj, LBRiiwa, Box_Gripper, Trajectory, Box, Candy, Start_Pose)
